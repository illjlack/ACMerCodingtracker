 ...
 */
@Entity
@Table(name = "user_try_problem", indexes = {
                ...
                @UniqueConstraint(name = "uk_user_problem_time", columnNames = { "user_id", "problem_id",
                                "attempt_time", "result" })
})
@Getter
@Setter
...
public class UserTryProblem implements Serializable, Comparable<UserTryProblem> {
        ...
        /** 关联的用户OJ账号 */
        @ManyToOne(fetch = FetchType.LAZY)
        @JoinColumn(name = "user_oj_id", nullable = true)
        ...
        public boolean equals(Object o) {
                if (this == o)
                        return true;
                if (!(o instanceof UserTryProblem))
                        return false;
