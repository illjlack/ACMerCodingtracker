...
(function() {
    ...
    function createTokenHelperButton() {
        ...
        toggleButton.title = '切换Token助手显示/隐藏';
    ...
    function setupToggleEvents(toggleButton) {
        toggleButton.addEventListener('click', function(e) {
            ...
            if (isHidden) {
                ...
                toggleButton.title = '显示Token助手';
            } else {
                tokenHelperButton.classList.remove('hidden');
                toggleButton.textContent = '🔑';
                toggleButton.title = '隐藏Token助手';
            }
        }, true);
    ...
    function setupButtonEvents() {
        ...
        // 触摸事件支持
        tokenHelperButton.addEventListener('touchstart', function(e) {
            if (isHidden) return;
            e.preventDefault();
            e.stopPropagation();
            e.stopImmediatePropagation();
        ...
        tokenHelperButton.addEventListener('touchmove', function(e) {
            if (isHidden) return;
            e.preventDefault();
            e.stopPropagation();
            e.stopImmediatePropagation();
        ...
        tokenHelperButton.addEventListener('touchend', function(e) {
            e.preventDefault();
            e.stopPropagation();
            e.stopImmediatePropagation();
            ...
            if (!isDragging && !isProcessing && !isHidden) {
                ...
                if (touchTime - dragStartTime > 200) {
                    getTokenForCurrentPlatform();
                }
            }
    ...
    function showNotification(message, type = 'info', duration = 3000) {
        ...
        const colors = {
            ...
            info: 'linear-gradient(135deg, #42a5f5 0%, #1976d2 100%)'
        };
